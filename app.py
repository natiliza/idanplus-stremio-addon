...
SECTION_CATALOGS: Dict[str, Dict[str, str]] = {
    "idanplus_live": {"type": "tv", "name": "עידן פלוס - טלוויזיה"},
    "idanplus_radio": {"type": "tv", "name": "עידן פלוס - רדיו"},
    "idanplus_vod": {"type": "channel", "name": "עידן פלוס - VOD"},
    "idanplus_radio_shows": {"type": "channel", "name": "עידן פלוס - תכניות רדיו"},
    "idanplus_podcasts": {"type": "channel", "name": "עידן פלוס - פודקאסטים"},
    "idanplus_music": {"type": "channel", "name": "עידן פלוס - מוזיקה"},
    "idanplus_favorites": {"type": "channel", "name": "עידן פלוס - מועדפים"},
    "idanplus_search": {"type": "channel", "name": "עידן פלוס - חיפוש"},
}
...
def build_search_results(query: str) -> List[dict]:
    ...
    searchable_catalogs = [
        key
        for key, cfg in SECTION_CATALOGS.items()
        if cfg["type"] == "channel" and key not in {"idanplus_search"}
    ]
    ...
    def _dispatch(self) -> None:
        ...
        if path == "/manifest.json":
            manifest = {
                ...
                "version": "0.3.0",
                "name": ADDON_NAME,
                "description": "Idan+ live TV plus channel-based VOD, radio shows, podcasts, music, favorites and search with hot-reloaded backend data.",
